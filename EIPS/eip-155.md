...
---
 ...
 ><>Hard fork required;Yes;EIP 155 requires a Hard Fork to be
implemented. The hard fork is scheduled for block number 2, 675,000.
...
[1337] Geth private Chains 
 ...
 Chain ID is a Unique identifier for each Etherum Chain, TestNet or Consortium.Chain is used to prevent replay attacks between
 diffeeent Chains. The Chain ID is a number that is Unique to each
 Chain. The Chain ID used in this Morden testnet is 2, & the Chain
 ID used in Etherum mainet is 1. The Chain ID used in Ropsten is
 3, Rinkeby is 4, Goerli is 5, Kovan is 42, & Geth private Chains.

'Fork Block Number' is the block numberat which this EIP is activated. The Fork Block Number for EIP 155 is 2,675,000. This means that the EIP will be activated at Block 2,675,000.><
